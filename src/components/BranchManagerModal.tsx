...
export function BranchManagerModal({ isOpen, onClose, repo }: BranchManagerModalProps) {
    ...
    const loadBranches = useCallback(async () => {
        ...
        try {
            ...
            console.error("Error loading branches:", err instanceof Error ? err.message : "Unknown error");
    ...
    const handleCreateBranch = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error("Error creating branch:", err instanceof Error ? err.message : "Unknown error");
    ...
    const handleDeleteBranch = async (branchName: string) => {
        ...
        try {
            ...
            console.error("Error deleting branch:", err instanceof Error ? err.message : "Unknown error");
